...
;		MVA #$C0 NMIEN	; switch on NMI+DLI again
		...
		CPY_AA	GRY_LINE_ADR SCR0
		SET_YX	40
		LDA #%01010101
		JSR	MEMSET		;		LDA #%01010101	;		LDX #<GRY_LINE_ADR	;		LDY #>GRY_LINE_ADR	;		STX SCR0+0	;		STY SCR0+1	;		LDX #>40	;		LDY #<40	;		JSR	MEMSET

		CPY_AA	BLK_LINE_ADR SCR0
		SET_YX	40
		LDA #%0; 10101010
		JSR	MEMSET		;		LDA #%10101010	;		LDX #<BLK_LINE_ADR	;		LDY #>BLK_LINE_ADR	;		STX SCR0+0	;		STY SCR0+1	;		LDX #>40	;		LDY #<40	;		JSR	MEMSET

		CPY_AA	(TXT_SCR_ADR-2) SCR0
		SET_YX	((5*40)+1)
		LDA #%11111111
		JSR	MEMSET		;		LDA #<(TXT_SCR_ADR -2)	;		STA SCR0+0	;		LDA #>(TXT_SCR_ADR -2)	;		STA SCR0+1	;		LDX #>((5*40)+1)	;		LDY #<((5*40)+1)	;		LDA #%11111111 ; 00000000	;		JSR	MEMSET

		CPY_AA	MAP_SCR_ADR SCR0
		SET_YX	(20*40) ; 42?
		LDA #%0; 10101010

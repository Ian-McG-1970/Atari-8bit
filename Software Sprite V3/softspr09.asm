...
.LOCAL	TSB_SCN_24 ; copy from screen buffer to temp buffer - size 1
			...
			TMP_SCN SRC25,DST25,24

			TMP_SCN SRC24,DST24,23
			TMP_SCN SRC23,DST23,22
			TMP_SCN SRC22,DST22,21
			TMP_SCN SRC21,DST21,20
			TMP_SCN SRC20,DST20,19
			TMP_SCN SRC19,DST19,18
			TMP_SCN SRC18,DST18,17
			TMP_SCN SRC17,DST17,16
...
.LOCAL	TSB_SCN_32 ; copy from screen buffer to temp buffer - size 1
			...
			TMP_SCN SRC33,DST33,32

			TMP_SCN SRC32,DST32,31
			TMP_SCN SRC31,DST31,30
			TMP_SCN SRC30,DST30,29
			TMP_SCN SRC29,DST29,28
			TMP_SCN SRC28,DST28,27
			TMP_SCN SRC27,DST27,26
			TMP_SCN SRC26,DST26,25
			TMP_SCN SRC25,DST25,24

...
INITIALIZE	        lda PORTB ; disable basic
		        ora #$02
		        sta PORTB
...
DRAW_BANK_LO_1:                   LDA   SCR_0_LO,Y
                                  STA   SCR_LO 
DRAW_BANK_HI_1:                   LDA   SCR_0_HI,Y
                                  STA   SCR_HI
                                  LDY   SCR_HOR,X
                                  LDA   (SCR),Y
DRAW_AND_OR_TAB_1:                AND   SCR_AND,X
                                  STA   (SCR),Y 
                                  LDA   LINE_FRAC
LINE_IXIY_INC:                    ADC   #0
                                  STA   LINE_FRAC
...
DRAW_BANK_LO_3:                   LDA   SCR_0_LO,Y
                                  STA   SCR_LO 
DRAW_BANK_HI_3:                   LDA   SCR_0_HI,Y
                                  STA   SCR_HI  
                                  LDY   SCR_HOR,X
                                  LDA   (SCR),Y
DRAW_AND_OR_TAB_3:                AND   SCR_AND,X
                                  STA   (SCR),Y   
                                  LDA   LINE_FRAC
LINE_DXDY_INC:                    ADC   #0
                                  STA   LINE_FRAC
...
DRAW_BANK_LO_2:                     LDA   SCR_0_LO,Y
                                    STA   SCR_LO 
DRAW_BANK_HI_2:                     LDA   SCR_0_HI,Y 
                                    STA   SCR_HI 
LINE_IYIX_CONT:                   LDY   SCR_HOR,X
                                  LDA   (SCR),Y
DRAW_AND_OR_TAB_2:                AND   SCR_AND,X
                                  STA   (SCR),Y 
                                  INX
LINE_IYIX_END:                    CPX   #0
                                  BNE   LINE_IYIX_LOOP
...
DRAW_BANK_LO_4:                     LDA   SCR_0_LO,Y
                                    STA   SCR_LO 
DRAW_BANK_HI_4:                     LDA   SCR_0_HI,Y 
                                    STA   SCR_HI 
LINE_DYDX_CONT:                   LDY SCR_HOR,X
                                  LDA (SCR),Y
DRAW_AND_OR_TAB_4:                AND SCR_AND,X
                                  STA (SCR),Y 
                                  INX
LINE_DYDX_END:                    CPX #0
                                  BNE LINE_DYDX_LOOP
...
SCREEN_FLIP	LDA	RTCLOK+2
SCREEN_FLIP_WAIT	CMP	RTCLOK+2  ; will be equal until incremented in VB
		BEQ	SCREEN_FLIP_WAIT
		RTS
		
SWAP_SCREEN	INC	SCREEN
		LDA	SCREEN
		LSR
		BCC	SET_SCREEN_1

SET_SCREEN_0		LDX	#>SCR_0
			...
			STY	PLOT_OR_LO+1
			STY	PLOT_AND_LO+1
			STX	DRAW_BANK_LO_1+2
			STX	DRAW_BANK_LO_2+2
			STX	DRAW_BANK_LO_3+2
			STX	DRAW_BANK_LO_4+2
			STY	DRAW_BANK_LO_1+1
			STY	DRAW_BANK_LO_2+1
			STY	DRAW_BANK_LO_3+1
			STY	DRAW_BANK_LO_4+1
			
			LDA	#$A5			
			LDY	#99
			JMP	CLEAR_SCREEN_1

SET_SCREEN_1	LDX	#>SCR_1
		STX	DISPLAY_LIST_SCREEN+1
...
SCR_1_LO	.BYTE <(SCR_1+(32*000)),<(SCR_1+(32*001)),<(SCR_1+(32*002)),<(SCR_1+(32*003)),<(SCR_1+(32*004)),<(SCR_1+(32*005)),<(SCR_1+(32*006)),<(SCR_1+(32*007))
	.BYTE <(SCR_1+(32*008)),<(SCR_1+(32*009)),<(SCR_1+(32*010)),<(SCR_1+(32*011)),<(SCR_1+(32*012)),<(SCR_1+(32*013)),<(SCR_1+(32*014)),<(SCR_1+(32*015))
	.BYTE <(SCR_1+(32*016)),<(SCR_1+(32*017)),<(SCR_1+(32*018)),<(SCR_1+(32*019)),<(SCR_1+(32*020)),<(SCR_1+(32*021)),<(SCR_1+(32*022)),<(SCR_1+(32*023))
	.BYTE <(SCR_1+(32*024)),<(SCR_1+(32*025)),<(SCR_1+(32*026)),<(SCR_1+(32*027)),<(SCR_1+(32*028)),<(SCR_1+(32*029)),<(SCR_1+(32*030)),<(SCR_1+(32*031))
	.BYTE <(SCR_1+(32*032)),<(SCR_1+(32*033)),<(SCR_1+(32*034)),<(SCR_1+(32*035)),<(SCR_1+(32*036)),<(SCR_1+(32*037)),<(SCR_1+(32*038)),<(SCR_1+(32*039))

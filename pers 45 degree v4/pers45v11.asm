...
.LOCAL	PERSPECTIVE	; in = Z_PNT_HI/Z_PNT_LO / X_PNT_HI/X_PNT_LO / Y_PNT_HI/Y_PNT_LO out = X_PNT_HI/X_PNT_LO / Y_PNT_HI/Y_PNT_LO
			ldx 	Z_PNT_LO 															; 3
			ldy 	Z_PNT_HI															; 3
			lda 	perslo,x ; zlo /4												; 4
			ora 	pershi,y ; lowest 2 bits of zhi shifted into top of zlo /4		; 4
			tax																	; 2
			lda 	perslo,y ; zhi /4												; 4

			clc															; 2
			adc		#>pers4096tabhi	; hi table pos							; 2
			sta		zhi+2													; 4
			adc		#4			; lo tables pos								; 2
			sta		zlo+2													; 4
zhi 		lda 	pers4096tabhi,x									; 4
			STA		Y1													; 3
zlo 		lda 	pers4096tabhi,x									; 4
			STA		Y0													; 3

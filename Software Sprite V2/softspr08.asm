...
.LOCAL	TSB_SCN_08 ; copy from screen buffer to temp buffer - size 1
			...
			TMP_SCN SRC09,DST09,8
 
			TMP_SCN SRC08,DST08,7
			TMP_SCN SRC07,DST07,6
			TMP_SCN SRC06,DST06,5
			TMP_SCN SRC05,DST05,4
			TMP_SCN SRC04,DST04,3
			TMP_SCN SRC03,DST03,2
			TMP_SCN SRC02,DST02,1
			TMP_SCN SRC01,DST01,0

			TMP_SCN SRC00,DST00,-1
...
.LOCAL	TSB_SCN_16 ; copy from screen buffer to temp buffer - size 1
			...
			TMP_SCN SRC17,DST17,16

			TMP_SCN SRC16,DST16,15
			TMP_SCN SRC15,DST15,14
			TMP_SCN SRC14,DST14,13
			TMP_SCN SRC13,DST13,12
			TMP_SCN SRC12,DST12,11
			TMP_SCN SRC11,DST11,10
			TMP_SCN SRC10,DST10,9
			TMP_SCN SRC09,DST09,8
...
SPRITE_SCB_TSB_LO   .BYTE <SCB_TSB_08,<SCB_TSB_16 ;,<BAKB_TMPB_24,<BAKB_TMPB_32
SPRITE_SCB_TSB_HI   .BYTE >SCB_TSB_08,>SCB_TSB_16 ;,>BAKB_TMPB_24,>BAKB_TMPB_32
SPRITE_SCB_TSB_SIZE .BYTE 1,1,1,1

SPRITE_SPR_TMP_LO   .BYTE <SPR_TSB_08,<SPR_TSB_16 ;,<SPRN_TMPB_24,<SPRN_TMPB_32
SPRITE_SPR_TMP_HI   .BYTE >SPR_TSB_08,>SPR_TSB_16 ;,>SPRN_TMPB_24,>SPRN_TMPB_32
SPRITE_SPR_TMP_SIZE .BYTE 16,32,48,64

SPRITE_TSB_SCN_LO   .BYTE <TSB_SCN_08,<TSB_SCN_16 ;,<TMPB_SCNB_24,<TMPB_SCNB_32
SPRITE_TSB_SCN_HI   .BYTE >TSB_SCN_08,>TSB_SCN_16 ;,>TMPB_SCNB_24,>TMPB_SCNB_32 
